...
../bin/fabric-ca-client register --id.type peer --id.name $PEER_NAME --id.secret password --id.affiliation $ORG_NAME 
...
../bin/fabric-ca-client enroll -u http://$PEER_NAME:password@localhost:7054
