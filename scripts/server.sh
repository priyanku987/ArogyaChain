...
export FABRIC_CA_SERVER_HOME='/home/priyanku/Desktop/major-project/ArogyaChain/ca-server'
...
function enroll {
    ...
    export FABRIC_CA_CLIENT_HOME='/home/priyanku/Desktop/major-project/ArogyaChain/client/ca-server/admin'
    ...
    ../bin/fabric-ca-client enroll -u http://admin:password@localhost:7054
}
...
function start {
    ...
    if [ -f "/home/priyanku/Desktop/major-project/ArogyaChain/ca-server/fabric-ca-server-config.yaml" ]
    then   
        echo "Using the /home/priyanku/Desktop/major-project/ArogyaChain/ca-server/fabric-ca-server-config.yamll"
    else
    ...
    ../bin/fabric-ca-server start 2> $FABRIC_CA_SERVER_HOME/server.log &
...
function enable-removal {
    ...
    then   
        ...
        ../bin/fabric-ca-server start --cfg.identities.allowremove 2> $FABRIC_CA_SERVER_HOME/server.log &
...
case $1 in
    ...
    "start")
        ...
        ;;
    "stop")
        killall ../bin/fabric-ca-server 2> /dev/null
