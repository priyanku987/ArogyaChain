...
../bin/fabric-ca-client register --id.type orderer --id.name orderer --id.secret password --id.affiliation orderer 
...
../bin/fabric-ca-client enroll -u http://orderer:password@localhost:7054
